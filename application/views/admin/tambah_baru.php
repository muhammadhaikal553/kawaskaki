...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    <div class="col-md-12">
        <h3 class="page-header" style="margin-top: 15px;margin:10px;">Tambah Barang<small></small></h3>
        <div class="col-sm-6">
            <form id="integerForm" class="form" method="POST" action="<?= base_url('admin/tambah_aksi'); ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-9">
                        <input type="text" name="kd_barang" class="form-control" required placeholder="Kode Barang" id="kd_barang">
                ...
                <div class="form-group row">
                    <label for="example-email-input" class="col-xs-3 col-form-label" id="input">Lokasi</label>
                    <div class="col-xs-9">
                        <input type="text" name="location" onkeyup="this.value = this.value.toUpperCase()" required class="form-control" id="location" placeholder="Lokasi" required>
                        <?= form_error('location', '<div class="text-small text-danger">', '</div>'); ?>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="example-search-input" class="col-xs-3 col-form-label" id="input">Pabrik Asal</label>
                    <div class="col-xs-9">
                        <input type="text" name="pabrik_asal" class="form-control" id="pabrik_asal" required placeholder="Pabrik Asal">
                        <?= form_error('pabrik_asal', '<div class="text-small text-danger">', '</div>'); ?>
                    </div>
                </div>

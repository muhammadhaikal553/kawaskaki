<div class="col-sm-10 col-sm-offset-3 col-md-30 col-md-offset-2 main">
    <div class="col-md-12">
        ...
        <div class="row">
            <h3 class="page-header" style="margin-top: 10px;margin:10px;">Pembungkus<small></small></h3>
            <div class="col-sm-9">
                <a href="<?= base_url('wrapping/tambah'); ?>" data-toggle="tooltip" title="Tambah"><i class="fa fa-plus-circle fa-2x" style="margin-bottom: 10px;padding: 0 0 0 5px;color:#5aab26;"></i></a> <a href="<?= base_url('wrapping/pdf'); ?>" data-toggle="tooltip" title="Print"><i class="fa fa-print fa-2x" style="margin-bottom: 10px;padding: 0 0 0 5px;color:#5aab26;"></i></a>
                <a href="<?= base_url('admin/excelwrap'); ?>" data-toggle="tooltip" title="Excel"><i class="fa fa-file-excel-o fa-2x" style="margin-bottom: 10px;padding: 0 0 0 5px;color:#5aab26;"></i></a>
                <form class="form-inline" method="post" action="<?= base_url('wrapping/search'); ?>" style="margin-bottom: -6px;">
                ...
                <table id="example" class="table table-bordered" width="5%">
                    <thead>
                        <tr style="font-size: 14px;">
                            ...
                            <th style='text-align: center;padding:6px;width: 120px;'>Nama Pembungkus</th>
                            <th style='text-align: center;padding:6px;width: 100px;'>Kode Pembungus</th>
                    ...
                    foreach ($wrap as $wrp) : ?>
                        <tbody>
                            <tr style='font-size: 13px;'>
                                ...
                                <td style='text-align: center;padding: 4px;'><?= $wrp->kd_pembungkus ?></td>
                                <td style='text-align: center;padding: 4px;'><?= $wrp->kategori ?></td>
                                <td style='text-align: center;padding: 4px;'><?= $wrp->stok ?></td>
                                <td style='text-align: center;padding: 4px;'><?= $wrp->satuan ?></td>
                            </tr>
                        </tbody>
                    <?php endforeach ?>
                </table>
